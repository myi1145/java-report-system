export default {
  ...
  analysis: {
    newUser: 'New user',
    visitsSum: 'Number of visits today',
    unreadInformation: 'Unread information',
    transactionAmount: 'Transaction amount',
    todayTotals: 'Day trading amount',
    totalShopping: 'Hospital admissions today',
    inHospSum: 'Total Shopping',
    monthlySales: 'Monthly sales',
    userAccessSource: 'User access source',
    rateType: 'Daily outpatient revenue',
    january: 'January',
    february: 'February',
    march: 'March',
    april: 'April',
    ...
    westernDrug: 'Western Drug',
    chineseHerb: 'Chinese Herb',
    test: 'Test',
    examine: 'Examine',
    treat: 'Treat',
    surgery: 'Surgery',
    ...
    embryoCulture: 'Embryo Culture',
    embryoFrozen: 'Embryo Frozen',
    ovaRetrieval: 'Ova Retrieval',
